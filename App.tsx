    ...
    return (
      <View style={styles.container}>
        <View style={styles.flexColumn}>
          ...
          <Text style={styles.location}>Ciheulang,  Sukabumi</Text>
          </View>
        <Image source={require('./asset/profil.jpg')} style={{ width: 44, height: 44, borderRadius:14, top:3, }} />
        </View>
       ...
       {/* Baner */}
        <View style={styles.PromoBaner}>
          <Image source={require('./asset/barista.jpg')}style={styles.PromoImage}/>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.row}>
          ...
          <View style={styles.card}>
            ...
            <Image 
              source={require('./asset/caffeine-coffee-cream-black-cup.jpg')} 
              style={styles.productImage} />
              <View style={styles.ratingContainer}>
                <Image source={require('./asset/Star.png')} style={styles.starImage} />
          ...
          <View style={styles.imageContainer}>
            <Image 
              source={require('./asset/cofe.jpeg')} 
              style={styles.productImage} 
            />
              <View style={styles.ratingContainer}>
                <Image source={require('./asset/Star.png')} style={styles.starImage} />
        ...
        <View style={styles.row}>
          ...
          <View style={styles.imageContainer}>
            <Image 
              source={require('./asset/brown-coffee.jpg')} 
              style={styles.productImage} 
            />
              <View style={styles.ratingContainer}>
                <Image source={require('./asset/Star.png')} style={styles.starImage} />
          ...
          <View style={styles.card}>
            <View style={styles.imageContainer}>
            <Image 
              source={require('./asset/barista.jpg')} 
              style={styles.productImage} 
            />
              <View style={styles.ratingContainer}>
                <Image source={require('./asset/Star.png')} style={styles.starImage} />
